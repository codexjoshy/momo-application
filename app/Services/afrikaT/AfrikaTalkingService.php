...
class AfrikaTalkingService
{
    ...
    public function sendAirtime(array $recipients, string $message = ""): array
    {
        foreach ($recipients as $recipient) {
            ...
            if (
                !array_key_exists('phoneNumber', $recipient) || !array_key_exists('currencyCode', $recipient) ||
                !array_key_exists('amount', $recipient)
            ) throw new Exception("valid keys are phoneNumber,currencyCode and amount ", 1);
